...
output_path = Path() / "Scripts/diffusion_flame_continuation_data"
...
f.restore("Scripts/Data/Run26_final_Z0.2000.h5", "extinction/0142")
factor_last_working = 5635856085811.2
...
for i in range(n_max):
    ...
    if ct.hdf_support():
        ut.save_with_attributes(f, output_path / 'flame_profiles.h5', f'iteration{i}', wall_params, z_stoich_val, info=True, runtime=runtime)
