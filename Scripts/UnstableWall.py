...
def solve_with_wall(f, wall_params, name_fallback="initial", delta_T_max=1., factor_increase=2, loglevel=0, control_params={}):
    error_counter = 0
    z_wall = wall_params["Z_wall"]
    delta_T_ok = False
    failed = False
...
for i in range(n_max):
    ...
    control_params = {"control_temperature": control_temperature,
                      ...
                      "right_control_point_temperature": f.right_control_point_temperature,
                      }
